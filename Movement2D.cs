...
public class Movement2D : MonoBehaviour
{
    ...
    private bool                isGrounded;         // 바닥 체크 (바닥에 닿아 있을 때 true)
    private Vector3             footPosition;       // 발의 위치

    [SerializeField]
    private int         maxJumpCount = 2; // 땅을 밟기 전까지 할 수 있는 점프 최대 회수
    private int         currentJumpCount = 0; // 현재 가능한 점프 회수
    ...
    {   
        ...
        // velocity.y <= 0 을 추가하지 않으면 점프키를 누르는 순간에도 초기화 되어
        // 최대 점프 회수를 2로 설정하면 3번까지 가능하게 된다
