...
public class PlatformDrop : PlatformBase
{
    ...
    private IEnumerator Process()
    {
        ...
        //재생성이 가능한 발판이면 respawnTime 이후 재생성
    ...
    private IEnumerator OnShake()
    {
        ...
        while (percent < 1)
        {
            ...
            float z = Mathf.Lerp(-shakeAngle, shakeAngle, Mathf.PingPong(Time.time * shakeSpeed, 1));//PingPong: 0~max 사이 값 return, value>max이면 남은 값을 +- 연산해 반환한 값을 계산
